...
@JvmOverloads constructor(sharedContext: EGLContext? = null, flags: Int = 0) {
    ...
    init {
        ...
        EGL14.eglQueryContext(mEGLDisplay, context, EGL14.EGL_CONTEXT_CLIENT_VERSION,
                values, 0)
    ...
    private fun getConfig(flags: Int, version: Int): EGLConfig? {
        ...
        val attribList = intArrayOf(EGL14.EGL_RED_SIZE, 8, EGL14.EGL_GREEN_SIZE, 8, EGL14.EGL_BLUE_SIZE, 8, EGL14.EGL_ALPHA_SIZE, 8, //EGL14.EGL_DEPTH_SIZE, 16,
...
//    }
    ...
    fun makeCurrent(eglSurface: EGLSurface) {
        ...
        if (!EGL14.eglMakeCurrent(mEGLDisplay, eglSurface, eglSurface, context)) {
    ...
    fun makeCurrent(drawSurface: EGLSurface, readSurface: EGLSurface) {
        ...
        if (!EGL14.eglMakeCurrent(mEGLDisplay, drawSurface, readSurface, context)) {
    ...
    fun isCurrent(eglSurface: EGLSurface): Boolean {
        return context == EGL14.eglGetCurrentContext() && eglSurface == EGL14.eglGetCurrentSurface(EGL14.EGL_DRAW)
    }
